...
public class ProductJpaRepositoryAdapter implements IProductRepository {
    ...
    private final IProductEventPublisher productEventPublisher;
    @Override
    public Product createProduct(Product product) {
        ...
        productEventPublisher.publishProductCreated(productCreated);
    ...
    public Product updateProduct(String id, Product product) {
        ...
        detail.setDescription(product.getDetail().description());
        detail.setSpecifications(product.getDetail().specifications());
        ...
        productEventPublisher.publishProductUpdated(productUpdated);
